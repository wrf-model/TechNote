...
\ref{figure:nest_domains}b). Currently, the software limit for the number of subdomains is 
...
Only the elevation of the topography and the landuse categories are elegible
to be input from high-resolution files instead of an interpolated
from the parent domain.
