...
Several lateral boundary condition options exist for ARW 
...
the specified boundaries in ARW: for the outer-most coarse grid or
...
Microphysical variables, except vapor, and all other scalars 
