...
A brief description of these additional components can by found in \citet{powers17}, but these will
...
options are chosen. Typically it requires emission source maps as additional inputs.
...
sub-grid relative to the atmospheric model.
