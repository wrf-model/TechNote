...
options and surface evaporation resistance options. There is also a crop model (GeCROS). NoahMP is linked to
all the urban options like Noah (UCM, BEP and BEM).
