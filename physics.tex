...
habits are carried which contain generalized particles that represent the whole evolution from ice to snow to graupel together with their number concentrations.
...
This is an updated SAS scheme operational in GFS since July 2010 \citep{han11}. In this version, 
...
\citet{angevine10} use total energy rather than TKE as a prognostic variable. This includes potential energy and kinetic
...
This also contains capabilities for fractional clouds and aerosols, but these are off by default,
